...
The simulation models a service management scenario (e.g., supermarket, bank, or ticket office) where clients arrive randomly, are distributed to queues, and are served concurrently.
...
- Clients are automatically assigned to the **shortest queue** upon arrival.  
- Each queue processes clients concurrently, decrementing service time as simulation time advances.  
- At each tick of simulation time:
  - Queues are updated
